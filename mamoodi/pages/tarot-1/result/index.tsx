...
import Tarot1Result from "@/components/tarot-1-result/tarot-1-result";

const Tarot1ResultPage = ({result}:any) => {
        ...
        <div>
            <Head>
                ...
                <meta name="description"
                    content={result.result.overall} />
                <meta name="og:description" content={result.result.overall} />
                <meta property="og:url" content={ "https://mamoodi.com/tarot-1/result?id=" + result.id} />
            ...
            <Tarot1Result result={result}></Tarot1Result>
        </div>
    )
}

export default Tarot1ResultPage;
