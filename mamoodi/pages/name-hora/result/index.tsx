...
import NameHoraResultComponent from "@/components/name-hora-result/name-hora-result";

const NameHoraResultPage = ({result}:any) => {
    ...
    return (
        <div>
            <Head>
                ...
                <meta property="og:url" content={ "https://mamoodi.com/name-hora/result?id=" + result.id} />
            ...
            <NameHoraResultComponent result={result}></NameHoraResultComponent>
        </div>
    )
}

export default NameHoraResultPage;
