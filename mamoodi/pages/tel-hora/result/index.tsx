...
import TelHoraResultComponent from "@/components/tel-hora-result/tel-hora-result";

const TelHoraResultPage = ({result}:any) => {
    ...
    return (
        <div>
            ...
            <TelHoraResultComponent result={result}></TelHoraResultComponent>
        </div>
    )
}

export default TelHoraResultPage;
